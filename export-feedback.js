...
async function exportFeedback() {
  try {
    ...
    const avgOverallRating = feedbacks.reduce((sum, f) => sum + f.overallRating, 0) / totalFeedbacks;
    const avgContentRating = feedbacks.reduce((sum, f) => sum + f.contentRating, 0) / totalFeedbacks;
    ...
    feedbacks.forEach((feedback, index) => {
      ...
      feedback.teacherRatings.forEach((rating, idx) => {
