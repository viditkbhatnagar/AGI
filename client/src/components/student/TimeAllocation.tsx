...
export default function TimeAllocation({ data }: Props) {
  return (
    <Card className="shadow-sm hover:shadow-lg transition-shadow mb-6 p-6">
      <div className="px-5 py-4 border-b"><h2 className="text-lg font-medium">Time Allocation to Documents and Quizzes</h2></div>
      <CardContent>
