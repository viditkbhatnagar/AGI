...
import { CalendarClock, CalendarPlus, Calendar, Edit, Ellipsis, ExternalLink, Plus, Search, SlidersHorizontal, Trash2 } from "lucide-react";
...
export function LiveClasses() {
  ...
  const filteredLiveClasses = data?.filter(liveClass => 
    liveClass.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
    liveClass.courseSlug.toLowerCase().includes(searchQuery.toLowerCase())
  );
            ...
            <div className="flex gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem>View Past Classes</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          </div>
                  ...
                  <TableRow key={liveClass._id}>
                    ...
                    <TableCell className="text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <Button variant="ghost" size="icon" onClick={() => setLocation(`/admin/live-classes/${liveClass._id}/edit`)}>
