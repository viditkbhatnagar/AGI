...
import { Edit, Eye, Plus, Search, SlidersHorizontal, Trash2, UserPlus } from "lucide-react";
...
export function Students() {
  ...
  const filteredStudents = data?.filter(student => 
    ...
    (student.enrollment?.courseSlug || "").toLowerCase().includes(searchQuery.toLowerCase())
  );
            ...
            <div className="flex gap-2">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem>Export Students</DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem>Send Bulk Notification</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          </div>
                  ...
                  <TableRow key={student._id}>
                    <TableCell>
                      <div className="flex items-center">
                        <div className="flex-shrink-0 h-10 w-10 bg-primary-100 rounded-full flex items-center justify-center">
                          <span className="font-medium text-primary-700">{getInitials(student.name)}</span>
                        </div>
                        <div className="ml-4">
                    ...
                    <TableCell>
                      <div className="text-sm text-gray-900">
                        {student.enrollment?.courseSlug || "No course"}
                      </div>
                    </TableCell>
                    <TableCell>
                      ...
                      <div>
                        ...
                        <div className="w-full h-1.5 bg-gray-200 rounded-full">
                          <div 
                            ...
                            style={{ width: `${student.courseProgress || 0}%` }}
                          />
                        </div>
                      </div>
                    </TableCell>
